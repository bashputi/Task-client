...
const CreateTask = () => {
    ...
    const onSubmit = async (data) => {
        ...
        console.log(data)
          ...
          fetch('https://task-server-red.vercel.app/tasks', {
            method: 'POST',
            headers: {
    ...
    return (
        ...
        <textarea {...register("notes")} className="textarea textarea-bordered textarea-warning w-full" rows="4"></textarea>
         ...
         <button className="btn bg-gray-200 btn-outline border-orange-500 border-0 border-b-4 mt-4">Create Task</button>
        </form>
      </div>
        </div>
    );

...
const Update = () => {
    ...
    const onSubmit = async (data) => {
        ...
        console.log(data)
          ...
          fetch(`https://task-server-red.vercel.app/usertasks/${_id}`, {
        method: 'PUT',
        headers: {
    ...
    <textarea defaultValue={notes} {...register("notes", { required: true })} className="textarea textarea-bordered textarea-warning w-full" rows="4"></textarea>
     ...
     <button className="btn bg-gray-200 btn-outline border-orange-500 border-0 border-b-4 mt-4">Update Now</button>
    </form>
  </div>
    </div>
    );
